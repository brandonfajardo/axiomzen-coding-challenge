...
import { findRepo, closeRepo, changeActiveTab } from "../../actions";
...
class IssuesList extends Component {
  componentWillMount() {
    ...
    const { user, repoName, page } = qs.parse(this.props.location.search);

    if (user && repoName && page) {
      this.props.findRepo(user, repoName, Number(page));
    }
  }
          ...
          <div className="tabContainer">
            <div className="tabContainerSpace">
              <div className="tabContainerRow">
                <p
                  onClick={() => changeActiveTab("allIssues")}
                  className={
                    tabActive === "allIssues" ? "tabActive" : "tabInactive"
                  }
                >
                  All Issues
                </p>
                <p
                  onClick={() => changeActiveTab("openIssues")}
                  className={
                    tabActive === "openIssues" ? "tabActive" : "tabInactive"
                  }
                >
                  Open Issues
                </p>
                <p
                  onClick={() => changeActiveTab("closedIssues")}
                  className={
                    tabActive === "closedIssues" ? "tabActive" : "tabInactive"
                  }
                >
                  Closed Issues
                </p>
                <p
                  onClick={() => changeActiveTab("prIssues")}
                  className={
                    tabActive === "prIssues" ? "tabActive" : "tabInactive"
                  }
                >
                  Pull Requests
                </p>
